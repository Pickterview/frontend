// src/components/Auth/LoginForm.jsx (기존 코드에서 handleLogin 함수 수정)
  ...
  const handleLogin = (e) => {
    ...
    if (username === "test1" && password === "1234") {
      ...
      const userInfo = {
        ...
        exp: 60, // 경험치 예시
        points: 42000, // 포인트 예시
        email: "platinum_user@pickterview.com", // 이메일 예시
      };
      localStorage.setItem("pickterviewUser", JSON.stringify(userInfo));
